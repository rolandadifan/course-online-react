...
import {statusCourses, watchCourse, messageCourse} from 'store/action/courses';
        ...
        <div className="flex">
            {
                ...
                <main className="flex-1">
                    <div className="px-4 sm:px-16">
                        <section className="flex flex-col mt-8 px-12 sm:pl-0">
                            <h1 className="text-xl sm:text-4xl text-gray-900 font-medium">{currentLesson?.name ?? "lesson name"}</h1>
                                ...
                                <div className="w-full px-4">
                                    <div className="relative">
                                        <div className="video-wrapper">
                                            {
                                                currentLesson?.video && 
                                                <Youtube videoId={currentLesson?.video} id={currentLesson?.video} opts={{ 
                                                    playerVars:{
                                                        autoplay: 1,
                                                        controls:1,
                                                        showinfo:0,
